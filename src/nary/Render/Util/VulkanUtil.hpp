...
public:
    ...
    static void           createBufferAndInitialize(VkDevice              device,
                                                    ...
                                                    void*                 data     = nullptr,
                                                    int                   datasize = 0);
    static void           copyBuffer(naDevice&    device,
                                     VkBuffer     srcBuffer,
                                     VkBuffer     dstBuffer,
    ...
    static VkImageView    createImageView(VkDevice           device,
                                          ...
                                          uint32_t           miplevels);
    static void           createGlobalImage(naDevice&          device,
                                            VkImage&           image,
    ...
    static void           createCubeMap(naDevice&            device,
                                        VkImage&             image,
                                        VkImageView&         image_view,
                                        VmaAllocation&       image_allocation,
                                        uint32_t             texture_image_width,
                                        ...
                                        VkFormat             texture_image_format,
                                        uint32_t             miplevels);
    static void           generateTextureMipMaps(naDevice&  device,
                                                 VkImage    image,
                                                 ...
                                                 uint32_t   layers,
                                                 uint32_t   miplevels);
    static void           transitionImageLayout(naDevice&          device,
                                                VkImage            image,
    ...
    static void           copyBufferToImage(naDevice&   device,
                                            VkBuffer    buffer,
                                            VkImage     image,
                                            uint32_t    width,
                                            uint32_t    height,
                                            uint32_t    layer_count);
    static void genMipmappedImage(naDevice& device, VkImage image, uint32_t width, uint32_t height, uint32_t mip_levels);
